...
<body>
    ...
    <div class="container mt-5">
        ...
        if (htmlspecialchars($type) == 'input') {
            echo "<form action='upload-exec.php?type=input' method='POST' enctype='multipart/form-data'>";
        } else {
        ...
        <?php if ($type === 'input') { ?>
            <a href="./thumbnail-input.php?type=input" target="_self" class="btn btn-secondary">Cancelar</a>
        <?php } else { ?>
            <a href="./thumbnail.php?<?php echo $ckeditorParams; ?>" target="_self" class="btn btn-secondary">Cancelar</a>
